...
<head>
	...
	<script>
		function send(f){
			...
			f.method = "POST";
			f.action = "manage_hyoiwon_imdaein_update.do";
			f.submit();
		}
	</script>
</head>
<body>
	...
	<div id="body">
	<form name="f">
		<input type="hidden" name="idx" size="50" value="${param.idx}">
		
		<p class="subtitle">임대인 정보 수정</p>
		<table>
			<tr class="top">
				<th>이름</th>
			...
			<tr>
				<th>건물명</th>
				<td><input name="gun_name" size="50" value="${param.gun_name}"></td>
			</tr>
			<tr>
				<th>이메일</th>
