			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "상호명을 입력하세요">
						<input class="input100" type="text" name="gong_name" placeholder="Real estate trade name">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<!-- 공인중개사 등록번호 입력 -->
					<div class="wrap-input100 validate-input" data-validate = "공인중개사 등록번호를 입력하세요">
						<input class="input100" type="text" name="gong_reg" placeholder="Reg-number">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<!-- 전화번호 입력 -->
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" onclick="send(this.form);">
							회원가입
						</button>
					</div>
