...
<html>
	<head>
		...
		<script>
			function reply() {
				location.href = "g_reply_form.do?id=${gongin_vo.id}&idx=${vo.idx}&page=${param.page}";
			}
		</script>
	</head>
	<body>
		...
		<form name="f" method="post">
			...
			<table width="1100" align="center">
				...
				<tr>
					<td align="center">
						<%-- 목록으로 돌아가기 --%>
						<input type="button" class="buttons_two" value="목록으로" onclick="location.href='g_login_main.do?id=${gongin_vo.id}&page=${param.page}'">
