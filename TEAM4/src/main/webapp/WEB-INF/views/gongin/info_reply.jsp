	...
	<body>
		...
		<form name="f" method="POST">
			...
			<table align="center" width="1100px" class="test">
				<caption class="subtitle">답글 등록</caption>
				<tr>
				...
				<tr>
					<td colspan="3" align="center" class="btns">
						<input type="button" class="buttons_two" value="등록" onclick="send_check();">
						<input type="button" class="buttons_two" value="취소" onclick="location.href='g_login_main.do?id=${gongin_vo.id}'">
						<%-- <img src="${pageContext.request.contextPath}/resources/img/btn_reg.gif" onclick="send_check();">
						<img src="${pageContext.request.contextPath}/resources/img/btn_back.gif" onclick="location.href='m_login_main.do?id=${manage_vo.id}&page=${param.page}'"> --%>
					</td>
				</tr>
			</table>
		</form>
