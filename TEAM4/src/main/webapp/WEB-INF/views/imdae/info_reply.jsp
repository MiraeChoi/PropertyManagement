...
<html>
	<head>
		...
		<script type="text/javascript">
			function send_check(){
				var f = document.f_imdae; //f라는 이름의 form을 검색
			...
			<table align="center" width="1100px" class="test">
				...
				<tr>
					<td colspan="3" align="center">
						...
						<input type="button" class="buttons_two" value="취소" onclick="location.href='i_login_main.do?id=${imdaein_vo.id}'">
					</td>
				</tr>
			</table>
		</form>
