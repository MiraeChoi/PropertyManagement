...
<body>
	...
	<div class="center_top">
		<h2>내 건물 관리</h2>
		<p align="center">내 건물을 등록하고 건물 정보를 수정하거나 삭제할 수 있습니다.</p>
	</div>
	...
	<div align="center"><input type="button" class="gun_reg_btn" value="새 건물 추가" onclick="location.href='gm_insert_form.do'"></div>
				...
				<tr class="underline">
					...
					<td>
						...
						<c:if test="${vo.reg_gyeyak_info eq 1}">
							<input type="button" class="m_btn m_reg" value="매물 등록됨" disabled="disabled">
						</c:if>
						<c:if test="${vo.reg_gyeyak_info ne 1}">
							<input type="button" class="m_btn" value="매물 등록" onclick="reg(${vo.idx});">
						</c:if>
