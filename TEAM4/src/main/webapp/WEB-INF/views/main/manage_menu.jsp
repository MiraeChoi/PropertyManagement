...
<html>
	<head>
		...
		<style>
			*{margin:0; padding:0;}
			...
			#name{text-align:right; padding:0 10px;}
			...
			#nav > li{text-decoration:none; float:left; position:relative; margin:3px 33px;}
	...
	<body>
		...
		<p id="btn_group">
			...
			<p id="name">
				<b>${manage_vo.name}</b>님 환영합니다.
				<input type="button" class="btn" value="로그아웃" onclick="location.href='logout.do'">
				<input type="button" class="btn" value="회원정보수정" onclick="location.href='user_modify_manage.do?id=${id}'">
			</p>
		</p>
		...
		<ul id="nav">
			...
			<li><a href="manage_hyoiwon.do">회원관리</a></li>
			<li><a href="manage_gongin_login_list.do">전체 매물 보기</a></li>
			<li><a href="total_gunmul_manage.do">전체 건물 관리</a></li>
		</ul>
		...
		<div id="slider-wrap">
		    <ul id="slider">
		        ...
		        <li><img src="${pageContext.request.contextPath}/resources/img/slide3_m.png"></li>
		    </ul>
