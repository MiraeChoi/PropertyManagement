...
<html>
	<head>
		...
		<style>
			*{margin:0; padding:0;}
			...
			#nav > li{text-decoration:none; float:left; position:relative; margin:3px 50px;}
	...
	<body>
		...
		<p id="btn_group">
			...
			<p id="name">
				<b>${gongin_vo.name}</b>님 환영합니다.
				<input type="button" class="btn" value="로그아웃" onclick="location.href='logout.do'">
				<input type="button" class="btn" value="회원정보수정" onclick="location.href='user_modify.do?id=${id}'">
			</p>
		</p>
		...
		<ul id="nav">
			...
			<li><a href="gongin_list.do">전체 매물목록</a></li>
			<li><a href="gongin_yeyak_list.do?yeyak_gongin_idx=${gongin_vo.idx}">예약 매물목록</a></li>
		</ul>
